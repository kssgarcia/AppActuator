...
vec3 getDisplacedPosition(vec3 _position)
{
    ...
    distoredPosition += perlin4d(vec4(distoredPosition * uDistortionFrequency, uTime * 0.0005)) * uDistortionStrength;

    float perlinStrength = perlin4d(vec4(distoredPosition * uDisplacementFrequency, uTime * 0.0005));
